...
import de.berlin.lostberlin.model.Order.ChosenBusiness;
import de.berlin.lostberlin.model.Order.OrderShortDao;
...
public interface ChosenBusinessRepository extends JpaRepository<ChosenBusiness, Long> {
    @Query("SELECT new de.berlin.lostberlin.model.Order.OrderShortDao (o.name, o.date, o.time, o.participantsNr, o.description)" +
